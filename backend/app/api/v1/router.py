...
from app.api.v1.endpoints import health, applications, auth, admin, revenue_workflow, notifications, documents, analytics, integrations
...
api_router.include_router(integrations.router, tags=["Cross-Department Integrations"])
